...
import { Camera, Plus, Trash2, Eye, EyeOff, Globe, Lock } from "lucide-react";
    ...
    <AppLayout role="admin" title="New Project" showBack>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <label className="text-sm font-medium text-foreground">Project Visibility</label>
          <div className="grid grid-cols-2 gap-2">
            <button
              type="button"
